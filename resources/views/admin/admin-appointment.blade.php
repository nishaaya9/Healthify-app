												...
												<tr>
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">Dr. {{$data->d_name}} {{$data->d_lname}}</a>
														</h2>
													</td>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="profile.html">{{$data->p_name}}</a>
														</h2>
													</td>
													<td>{{$data->appointment_date}} <span class="text-primary d-block">{{$data->appointment_time}}</span></td>
													<td class="text-right">
														{{$data->fees}}
													</td>
												</tr>
